...
<style type="text/css">
body {
	background: url('http://www.wallpaper-box.com/sea/images/sea42.jpg');
...
{if $next_page_flg == true}
	<a href="./inquiry_list.php?sort={$sort}&{$uri_params|unescape}&p={$next_page}" class="btn btn-normal">next</a><br>
{else}
